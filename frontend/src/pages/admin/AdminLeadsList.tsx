  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FAF9F6' }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
        {leads.length === 0 ? (
          <div className="rounded-xl shadow-sm border border-gray-200/60 p-12 text-center" style={{ backgroundColor: '#FEFDFB' }}>
                        ...
                        <div className="flex items-center">
                          <div className="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center mr-2 flex-shrink-0">
                            <span className="text-xs font-medium text-gray-700">
                              {(lead.assignedTo?.name || 'Unknown').charAt(0).toUpperCase()}
                            </span>
                          </div>
                          <div className="text-sm text-gray-700">{lead.assignedTo?.name || 'Unknown'}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
